...
\begin{tabular}[c]{%
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{getting spade cards in all 5 trials}}
	&
	\\
	\hhline{|--|~}
	\multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{3 out of 5 trials get spade cards}}
	&
	\\
	\hhline{|--|~}
	\multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{0 out of 5 trials get spade cards}}
	&
	\\
	\hhline{|-|-|~}
	\\
